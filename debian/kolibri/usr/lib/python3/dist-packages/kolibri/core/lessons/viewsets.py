from .serializers import LessonSerializer, ClassChannelSerializer
from kolibri.auth.api import KolibriAuthPermissions
from kolibri.auth.api import KolibriAuthPermissionsFilter
from django_filters.rest_framework import DjangoFilterBackend
from kolibri.core.lessons.models import Lesson, ClassChannel
...
# Viewset Added by Vimal Rugahni
# To handle requirement of Class Channel Mapping 
class ClassChannelViewset(ModelViewSet):
    serializer_class = ClassChannelSerializer
    filter_backends = (DjangoFilterBackend,)
    filter_fields = ('collection',)
    queryset = ClassChannel.objects.all()

    def get_serializer_class(self):
        return ClassChannelSerializer