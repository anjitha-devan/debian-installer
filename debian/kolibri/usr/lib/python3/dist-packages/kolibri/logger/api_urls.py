...
from .api import (
    ...
    TotalContentProgressViewSet, UserSessionLogViewSet, ReportsDataOfflineViewSet
)
...
router.register(r'reportsdataoffline', ReportsDataOfflineViewSet, base_name='reportsdataoffline')
