...
# from kolibri.content.serializers import ReportsDataOfflineSerializer
# from kolibri.content.models import ReportsDataOffline
from .models import AttemptLog, ContentSessionLog, ContentSummaryLog, ExamAttemptLog, ExamLog, MasteryLog, UserSessionLog, ReportsDataOffline
...
from .serializers import (
    ...
    TotalContentProgressSerializer, UserSessionLogSerializer, ReportsDataOfflineSerializer
)
...
class ReportsDataOfflineFilter(FilterSet):
    content = CharFilter(method="filter_content")
...
class ReportsDataOfflineViewSet(viewsets.ModelViewSet):
    # permission_classes = (KolibriAuthPermissions,)
    # filter_backends = (KolibriAuthPermissionsFilter, DjangoFilterBackend)
    queryset = ReportsDataOffline.objects.all()
    serializer_class = ReportsDataOfflineSerializer
